...
export default function CreateSalesOfficeForm() {
	...
	const handleCancel = () => {
		navigate("/business-structure/display-sales-office");
	};
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			const checkResponse = await fetch(
				`${BASE_URL_MS}/sales-offices/${formData.salesOfficeId}`
			);
			...
			if (checkResponse.status === 200) {
				...
				if (exists) {
					// setErrors(prev => ({
					//   ...prev,
					//   salesOfficeId: `ID "${formData.salesOfficeId}" already exists. Please use a different code.`,
					// }));
					alert(
						`ID "${formData.salesOfficeId}" already exists. Please use a different code.`
					);
					setIsSubmitting(false);
					return;
				}
			...
			if (!response.ok) {
				...
				throw new Error(
					errorData.message || "Failed to create sales office"
				);
			}
			...
			alert(
				error.message ||
					"An error occurred while creating the sales office"
			);
		} finally {
			setIsSubmitting(false);
		}
	...
	return (
		<div className="create-sales-office-container">
			<form onSubmit={handleSubmit}>
				...
				<div className="create-sales-office-header-box">
					<h2>Sales Office Information</h2>
					<div className="data-container">
						<div className="data">
							<label htmlFor="salesOfficeId">ID*</label>
							...
							<input
								...
								className={errors.salesOfficeId ? "error" : ""}
							/>
							{errors.salesOfficeId && (
						...
						<div className="data">
							...
							<input
								...
								onChange={handleChange}
								maxLength={50}
								placeholder="Enter sales office description"
								className={
				...
				<div className="create-sales-office-item-box">
				...
				<div className="create-sales-office-button-group">
					<button
						type="submit"
						disabled={isSubmitting}
						className="create-sales-office-save-button"
					>
						{isSubmitting ? "Saving..." : "Save"}
					</button>
					<button
						type="button"
						className="create-sales-office-cancel-button"
