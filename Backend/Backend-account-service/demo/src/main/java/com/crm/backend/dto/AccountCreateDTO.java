...
// // DTO for creating an account (input from request body).
// // Excludes id, timestamps (auto-generated).
// @Data
// public class AccountCreateDTO {
...
//     private String parentAccountId;  // For relation (connect by accountId)
//     private String note;
