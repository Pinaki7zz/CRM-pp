...
const DetailedSalesOrder = () => {
	...
	const [errors, setErrors] = useState({}); // { orderOwnerId: "Owner ID is required", name: "..." }
	...
	// 1️⃣ Fetch the order on mount
	const fetchSalesOrder = async () => {
		try {
			const res = await fetch(`${BASE_URL_SM}/sales-order/${id}`);
			if (!res.ok) {
			...
			const normalized = {
				...
				orderOwnerId: data.orderOwnerId,
				name: data.name,
			...
			setAttachments(data.salesOrderAttachments || []);
		} catch (err) {
			console.error("Error fetching sales order:", err);
			toast.error("Error fetching sales order");
		}
	};
	...
	useEffect(() => {
		...
		async function load() {
			await fetchAccounts();
			await fetchSalesOrder(); // now accounts[] already has contacts
		}
		load();
	}, [id]);
	...
	const handleSave = async (type) => {
		try {
			...
			const response = await fetch(`${BASE_URL_SM}/sales-order/${id}`, {
				method: "PATCH",
				headers: {
	...
	const getOwnerDisplayName = () => {
		if (!formData.orderOwnerId || users.length === 0) return "--";

		const owner = users.find(
			(u) => String(u.id) === String(formData.orderOwnerId),
		);
	...
	const handleAttachmentUpload = async (e) => {
		...
		try {
			const res = await fetch(
				`${BASE_URL_SM}/sales-order/${id}/attachments`,
				{
					method: "POST",
					body: uploadData,
				},
			...
			fetchSalesOrder(); // Reload sales order including files
		} catch (err) {
	...
	const handleDeleteAttachment = async (attachmentId) => {
		try {
			const res = await fetch(
				`${BASE_URL_SM}/sales-order/${id}/attachments/${attachmentId}`,
				{ method: "DELETE" },
			);
	...
	const handleAddNote = async (e) => {
		...
		try {
			const res = await fetch(`${BASE_URL_SM}/sales-order/${id}/notes`, {
				method: "POST",
	...
	const handleDeleteNote = async (noteId) => {
		try {
			const res = await fetch(
				`${BASE_URL_SM}/sales-order/${id}/notes/${noteId}`,
				{
					method: "DELETE",
				},
			);
	...
	return (
		<div className="so-edit-container">
			{/* Sales Orders Name Section */}
			<div className="so-edit-header-container">
				<h1 className="so-edit-heading">Sales Order Details</h1>
				<div className="so-edit-header-container-buttons">
					{isReadOnly ? (
						<>
							<button
								className="so-edit-edit-button"
								onClick={() => {
									setIsReadOnly(false);
									setErrors({});
								}}
							...
							<button
								className="so-edit-convert-button"
							...
							<div
								className="so-edit-options-button-container"
								ref={actionRef}
							>
								<button
									className="so-edit-options-button"
									onClick={() =>
								...
								{/* Menu Modal */}
								{menuModal && (
									<div className="so-edit-menu-modal-container">
										<ul className="so-edit-menu-modal-list">
						...
						<>
							...
							<button
								className="so-edit-cancel-button"
								onClick={() => {
									setIsReadOnly(true);
									setErrors({});
			...
			<div className="so-edit-tabs-container">
				<div className="so-edit-tabs-container-left">
					<button
						className={`so-edit-tab ${
				...
				{activeTab === "interactions" && (
					<div className="so-edit-tabs-container-right">
						<button
							className="so-edit-email-button"
				...
				{activeTab === "notes" && (
					<div className="so-edit-tabs-container-right">
						<button
							className="so-edit-add-note-button"
				...
				{activeTab === "activities" && (
					<div className="so-edit-tabs-container-right">
						...
						<button
							className="so-edit-meeting-button"
							onClick={() =>
				...
				{activeTab === "attachments" && (
					<div className="so-edit-tabs-container-right">
						<button
							className="so-edit-attach-button"
							type="button"
							onClick={() =>
								document
			...
			{activeTab === "overview" && (
				<>
					{/* Overview Container */}
					<div className="so-edit-form-container">
						<h1 className="so-edit-form-heading">Overview</h1>
						<div className="so-edit-form">
							<form>
								<div className="so-edit-form-row">
									<div className="so-edit-form-group orderId">
									...
									<div className="so-edit-form-group status">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group orderOwnerId">
									...
									<div className="so-edit-form-group dueDate">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group budget">
									...
									<div
										className="so-edit-form-group status"
					...
					<div className="so-edit-form-container">
						<h1 className="so-edit-form-heading">
						...
						<div className="so-edit-form">
							<form>
								...
								<div className="so-edit-form-row">
									...
									<div className="so-edit-form-group opportunityId">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group accountId">
									...
									<div className="so-edit-form-group primaryContactId">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group subject">
									...
									<div className="so-edit-form-group amount">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group purchaseOrder">
								...
								<div className="so-edit-form-row">
									...
									<div className="so-edit-form-group commission">
					...
					<div className="so-edit-form-container">
						...
						<div className="so-edit-form">
							<form>
								<div className="so-edit-form-row">
									<div className="so-edit-form-group billingCountry">
									...
									<div className="so-edit-form-group shippingCountry">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group billingState">
									...
									<div className="so-edit-form-group shippingState">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group billingCity">
									...
									<div className="so-edit-form-group shippingCity">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group billingStreet">
									...
									<div className="so-edit-form-group shippingStreet">
								...
								<div className="so-edit-form-row">
									<div className="so-edit-form-group billingPostalCode">
									...
									<div className="so-edit-form-group shippingPostalCode">
					...
					<div className="so-edit-table-container">
						<h1 className="so-edit-table-heading">
							Product Information
						</h1>
						<div className="so-edit-table-area">
							<div className="so-edit-table-box">
								<table className="so-edit-table">
									<thead>
										<tr>
											<th>Sl. No.</th>
											<th>Product Name *</th>
									...
									<tbody>
										{items.map((item, idx) => (
											<tr key={idx}>
												<td>{idx + 1}.</td>
												<td>
													<div className="so-edit-table-data">
														{isReadOnly ? (
															(products.find(
																(p) =>
																	p.productId ===
												...
												<td>
													<button
														className="so-edit-product-delete-btn"
														type="button"
														onClick={() =>
															removeItem(idx)
														}
							...
							<div className="so-edit-table-bottom">
								<span>* Required Field</span>
								<button
									className="so-edit-add-product-btn"
									type="button"
									onClick={addItem}
									disabled={isReadOnly}
								>
			...
			{activeTab === "interactions" && (
				<>
					<div className="so-edit-form-container">
						<h1 className="so-edit-form-heading">Email</h1>
						<div className="so-edit-email-container">
							<div className="so-edit-email-tabs-container">
								<div className="so-edit-tabs-left">
									<button
										className={`so-edit-email-tab-btn ${
							...
							<div className="so-edit-email-list-container">
								{activeEmailTab === "interactions" &&
														...
														emailInteractions.map(
															(email) => (
																...
																>
																	...
																	<td className="so-edit-subject-text">
																		{
																			email.subject
																		}
																	</td>
								...
								{activeEmailTab === "interactions" &&
									selectedEmailInteraction && (
										<div className="so-edit-email-detail-view">
											<div>
												<button
													onClick={() =>
														setSelectedEmailInteraction(
			...
			{activeTab === "notes" && (
				<>
					{/* Notes Container */}
					<div className="so-edit-notes-container">
						<h1 className="so-edit-notes-heading">Notes</h1>
						<div className="so-edit-notes-form">
							{notes.length > 0 ? (
								<ul className="so-edit-note-box-list">
									{notes.map((note) => (
										<li
											key={note.id}
											className="so-edit-note-item"
										>
											<div className="so-edit-note-text">
												{note.text}
											</div>
											<div className="so-edit-note-footer">
												<div className="so-edit-note-meta">
													<User size={12} />{" "}
													{note.author}
													<span
														style={{
												...
												<button
													className="so-edit-note-delete-btn"
													onClick={() =>
														handleDeleteNote(
															note.id,
														)
								...
								<div className="so-edit-notes-empty">
									No Note Found
								</div>
							)}
						</div>
			...
			{activeTab === "activities" && (
				<>
					{/* Activities Section */}
					<div className="so-edit-activity-table-container">
						<table className="so-edit-activity-table">
							<thead>
								<tr>
									<th>Activities</th>
									<th>Date & Time</th>
							...
							<tbody>
								{activities.length === 0 ? (
									<tr>
										<td
											colSpan="9"
											className="so-edit-activity-empty-state"
										>
			...
			{activeTab === "attachments" && (
				<>
					{/* Attachments Section */}
					<div className="so-edit-table-container">
						<h1 className="so-edit-table-heading">Attachments</h1>
						<div className="so-edit-table-area">
							<div className="so-edit-table-box">
								<table className="so-edit-table">
									<thead>
										...
										{attachments.length === 0 ? (
											...
											attachments.map((file) => (
												<tr key={file.id}>
													...
													<td>
														<button
															className="so-edit-attachment-delete-btn"
															title="Delete"
															onClick={() =>
			...
			{showComposeMail && (
				<div
					className={`so-edit-compose-mail-window ${
						isMinimized ? "minimized" : ""
					}`}
				>
					<div
						className="so-edit-compose-mail-header"
						onClick={() => setIsMinimized(!isMinimized)}
					>
						<h2 className="so-edit-compose-title">Send Email</h2>
						<div className="so-edit-compose-controls">
							<button
								onClick={(e) => {
									e.stopPropagation();
									setIsMinimized(!isMinimized);
								}}
								className="so-edit-compose-control-btn"
							>
					...
					{!isMinimized && (
						<>
							<div className="so-edit-compose-body">
								<div className="so-edit-compose-field">
									<label>To</label>
									<input
								...
								<div className="so-edit-compose-editor">
									<textarea
								...
								{composeAttachments.length > 0 && (
									<div className="so-edit-compose-attachments">
										{composeAttachments.map((file, idx) => (
											<div
												key={idx}
												className="so-edit-compose-attachment-chip"
											>
												<Paperclip size={12} />
												<span className="so-edit-compose-attachment-name">
													{file.name}
												</span>
												<button
													onClick={() =>
							...
							<div className="so-edit-compose-footer">
								<div className="so-edit-compose-tools">
									<input
										type="file"
										multiple
										ref={composeFileRef}
									...
									<Paperclip
										size={24}
										className="so-edit-compose-tool-icon"
										onClick={() =>
								...
								<div className="so-edit-compose-actions">
									<button
			...
			{/* Add Note Modal */}
			{showNoteModal && (
				<div className="so-edit-note-modal-overlay">
					<div className="so-edit-note-modal-content medium">
						<div className="so-edit-note-modal-header">
							<h3 className="so-edit-note-modal-title">
								Add Note
							</h3>
							<button
								onClick={() => {
								...
								className="so-edit-note-modal-close-btn"
							>
								<X size={20} strokeWidth={1} color="#0f1035" />
							</button>
						</div>
						<div className="so-edit-note-modal-body">
							<textarea
								placeholder="Enter your note here..."
								value={newNote}
								onChange={(e) => setNewNote(e.target.value)}
								className="so-edit-note-textarea"
							/>
						</div>
						<div className="so-edit-note-modal-footer">
							<button
								onClick={() => {
									setShowNoteModal(false);
									setNewNote("");
								}}
								className="so-edit-note-btn-secondary"
							>
								Cancel
							</button>
							<button
								onClick={handleAddNote}
								className="so-edit-note-btn-primary"
							>
								Save Note
							</button>
						</div>
			...
			{showConvertModal && (
				<div className="so-edit-convert-modal-overlay">
					<div className="so-edit-convert-modal">
						<h3 className="so-edit-convert-modal-title">
							Convert Sales Order to Invoice?
						</h3>

						<div className="so-edit-convert-modal-actions">
							<button
								className="so-edit-convert-btn-primary"
								// onClick={handleConfirmConvert}
							>
								Convert
							</button>
							<button
								className="so-edit-convert-btn-secondary"
...
export default DetailedSalesOrder;
